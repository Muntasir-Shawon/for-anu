...
export const loveStory: LoveStoryConfig = {
    ...
    items: [
      {
        ...
        text: [
          ...
          "Two people talking, laughing, sharing little things...",
          "And somehow those little things became some of my favorite memories.",
        ],
        image: "/images/memory-01.jpg",
        caption: "Where every quiet conversation felt like home.",
      },
      {
        id: "mem-02",
        number: "MEMORY 02",
        title: "The unscripted moments",
        text: [
          "Some moments don't look special when they happen.",
          "But later, you realize...",
          "Those were the moments you wanted to keep forever.",
        ],
        image: "/images/memory-02.jpg",
        caption: "Treasured forever in my heart.",
      },
      {
        id: "mem-03",
        number: "MEMORY 03",
        ...
        text: [
          "You made ordinary days feel different.",
          "A normal conversation with you could make my whole day better.",
          "A simple moment could become a memory I keep thinking about.",
        ],
        image: "/images/memory-03.jpg",
        caption: "Even a quiet evening was magical with you.",
      },
      {
        id: "mem-04",
        number: "MEMORY 04",
        title: "Real & imperfect",
        text: [
          "We are not perfect.",
        ...
        caption: "Through every storm and every sunset.",
      },
      {
        id: "mem-05",
        number: "MEMORY 05",
        ...
        text: [
          ...
          "I probably couldn't choose one.",
          "Because it's not one particular day.",
          "It's all those little moments with you.",
          "Just being with you.",
        ],
        image: "/images/memory-05.jpg",
        caption: "Forever my favorite sanctuary.",
      },
    ],
  },
  ...
  gallery: {
    ...
    subheadline: [
      ...
      "They're little pieces of our story.",
    ...
    items: [
      {
        ...
        caption: "The way the light hits your face will always be my favorite view.",
      ...
      },
      {
        id: "gal-02",
        title: "Quiet Strolls",
        caption: "Walking beside you, forgetting whatever else was on my mind.",
      ...
      },
      {
        ...
        caption: "When you laughed so hard your eyes closed.",
      ...
      },
      {
        id: "gal-04",
        title: "Warm Evenings",
        caption: "Holding hands in the cool night breeze.",
      ...
      },
      {
        ...
        caption: "The smile that quietly reset my whole mood.",
      ...
      },
      {
        ...
        caption: "Catching you looking over when you thought I wasn't noticing.",
      ...
      },
      {
        ...
        caption: "Every road feels right when you're next to me.",
      ...
      },
      {
        ...
        caption: "Under the city lights, talking about our dreams.",
      ...
      },
      {
        id: "gal-09",
        title: "Comfort & Peace",
        caption: "In your presence, the whole world slows down.",
      ...
      },
      {
        id: "gal-10",
        title: "Pure Grace",
        caption: "Effortlessly beautiful, every single day.",
